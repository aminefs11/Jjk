...
# Bot API Token
API_TOKEN = "6912387124:AAHVQwcHSD226anBNROJKkO2jZTHgSqZa9s"
API_ID ="27733303"
API_HASH ="c3c9d5e5d89c99fb8bb85a22a0cb5a26"
# OpenAI API Key
openai.api_key = "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"
#Only owner id
DEVIL = "1965898154"
# MongoDB setup
MONGODB_URI = "mongodb+srv://aminebaggari12:amineba@clamimoc.qj2hllv.mongodb.net/?retryWrites=true&w=majority"  # Set your MongoDB connection string here
...
def start_bot(client, message):
    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text="🔰 Buy AmineGPT 🔰", callback_data="help"),
                InlineKeyboardButton(text="💻 About AmineGPT 💻", callback_data="about"),
            ],
            [
             InlineKeyboardButton(text="💠 AmineGPT Ai Dev 💠", callback_data="admin"),
